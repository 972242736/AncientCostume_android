...
import com.mmf.ancientcostume.common.utils.SupportedSizesReflect;
 ...
 * @version 1.0.0
 */
public class RecordActivity extends Fragment implements Callback, MediaPlayer.OnPreparedListener, OnBufferingUpdateListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.layout_video_record1, null);
        setTitleStr("");
    ...
    private void initView() {
        ...
        recordPlayIv = (ImageView) view.findViewById(R.id.recordPlayIv);
...
//		         camera.setParameters(parameters); 
    ...
    protected void setTitleStr(String str) {
        TextView titleText = (TextView) view.findViewById(R.id.common_title_text);
        ...
        Button right_button = (Button) view.findViewById(R.id.right_button);
...
//			parameters.setPictureFormat(PixelFormat.JPEG);
    ...
    public void onCompletion(MediaPlayer arg0) {
        // TODO Auto-generated method stub
        SupportedSizesReflect.LogsUtil.i(TAG, "onCompletion");
        if (mediaPlayer != null) {
            mediaPlayer.release();
            mediaPlayer = null;
        }
