...
import com.mmf.ancientcostume.other.zhy.utils.ImageLoader;
...
public class AutoLoadRecyclerView extends RecyclerView  {
     ...
     * @param pauseOnFling
     */
    public void setOnPauseListenerParams(Picasso imageLoader, boolean pauseOnScroll, boolean pauseOnFling) {
    ...
    private class AutoLoadScrollListener extends OnScrollListener {
        ...
        public AutoLoadScrollListener(Picasso imageLoader, boolean pauseOnScroll, boolean pauseOnFling) {
            super();
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (imageLoader != null) {
                switch (newState) {
                    case 0:
                        imageLoader.resumeTag(1);
                        break;

                    case 1:
                        if (pauseOnScroll) {
                            imageLoader.pauseTag(1);
                        } else {
                            imageLoader.resumeTag(1);
                        }
                        break;
